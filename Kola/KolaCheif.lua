...
local SquadMonchegorsk=SQUADRON:New("SQ MIG-31#1", 2, "204th") --Ops.Squadron#SQUADRON
...
SquadMonchegorsk:SetTakeoffHot()
...
MonchegorskWing:NewPayload(GROUP:FindByName("SQ MIG-31#1"), -1, {AUFTRAG.Type.INTERCEPT,AUFTRAG.Type.CAP,AUFTRAG.Type.ALERT5}, 100)
