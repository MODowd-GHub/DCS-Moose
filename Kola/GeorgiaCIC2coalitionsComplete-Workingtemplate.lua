...
--Flanker Squadron.
local SquadSochi=SQUADRON:New("SQ CCCP SU27-1", 4, "243rd") --Ops.Squadron#SQUADRON
...
---Backfire Squadron
local SquadBackfire=SQUADRON:New("SQ CCCP TU-22M", 6, "23rd (Sochi)") --Ops.Squadron#SQUADRON
SquadBackfire:SetGrouping(2) -- Two aircraft per group X 6 = 12 airframes
...
SquadBackfire:SetMissionRange(200) -- Squad will be considered for targets within 200 NM of its airwing location.

--- AIRWING Gudauta
local GudautaWing=AIRWING:New("Warehouse Gudauta", "773rd (Gudauta)") --Ops.AirWing#AIRWING
--- AIRWING Sochi
local SochiBackfire=AIRWING:New("Sochi Airbase", "23rd (Sochi)") --Ops.AirWing#AIRWING
...
SochiBackfire:AddSquadron(SquadBackfire)
...
GudautaWing:NewPayload(GROUP:FindByName("SQ CCCP MIG-29"), -1, {AUFTRAG.Type.INTERCEPT,AUFTRAG.Type.CAP,AUFTRAG.Type.ALERT5}, 100)
SochiBackfire:NewPayload(GROUP:FindByName("SQ CCCP TU-22M"), -1, {AUFTRAG.Type.ANTISHIP }, 100)
SochiFlanker:NewPayload(GROUP:FindByName("SQ CCCP SU27-1"), -1, {AUFTRAG.Type.INTERCEPT,AUFTRAG.Type.CAP, AUFTRAG.Type.ALERT5, Auftrag.Type.ESCORT}, 100)
---
-- RedChief OF STAFF
---
...
RedChief:AddAirwing(SochiBackfire)
...
RedChief:SetStrategy(RedChief.Strategy.DEFENSIVE)
...
SquadKobuleti:SetTakeoffAir()
SquadKobuleti:AddMissionCapability({AUFTRAG.Type.ANTISHIP}, 100) -- Squad can do intercept missions.
--SquadKobuleti:AddMissionCapability({AUFTRAG.Type.ALERT5})        -- Squad can be spawned at the airfield in uncontrolled state.
SquadKobuleti:SetMissionRange(300) -- Squad will be considered for targets within 200 NM of its airwing location.
...
KutaisiWing:NewPayload(GROUP:FindByName("SQ NATO SU-27"), -1, {AUFTRAG.Type.INTERCEPT,AUFTRAG.Type.CAP,AUFTRAG.Type.ALERT5}, 100)
...
BlueCheif:SetResponseOnTarget(2, 4, 3, TARGET.Category.NAVAL, AUFTRAG.Type.ANTISHIP)
