...
A2ADispatcherRed:SetSquadron( "KishCAP", AIRBASE.PersianGulf.Kish_International_Airport, { "SQ IRI MIG21" }, 4 )
...
A2ADispatcherRed:SetSquadron( "HavadaryaCAP", AIRBASE.PersianGulf.Havadarya, { "SQ IRI MIG21" }, 2 )
