...
A2ADispatcherRed:SetSquadron( "Gudauta", AIRBASE.Caucasus.Gudauta, { "SQ CCCP MIG-23 CW" }, 8 )
A2ADispatcherRed:SetSquadron( "Sochi", AIRBASE.Caucasus.Sochi_Adler, { "SQ CCCP MIG-25 CW" }, 2)
A2ADispatcherRed:SetSquadron( "Sukhumi", AIRBASE.Caucasus.Sukhumi_Babushara, { "SQ CCCP MIG-21 CW" , "SQ CCCP MIG-23 CW" }, 4)
A2ADispatcherNATO:SetSquadron( "Kutaisi", AIRBASE.Caucasus.Kutaisi, { "SQ NATO F5", "SQ NATO F4E" }, 6)
...
A2G_Blue:SetSquadron( "BAI", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO A-4" }, 4 )
...
A2G_Blue:SetSquadron( "CAS", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO F-1" }, 6 )
...
A2G_Blue:SetSquadron( "SEAD", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO F4G" }, 4 )
...
--local function isGroupInZone()
   ...
   -- local zone = ZONE:FindByName ("BlueCap1")

   --if group:IsAlive()==true and group:IsCompletelyInZone( zone )	then
    --  redmantis:SetNewSAMRangeWhileRunning(30)
	--	else
