...
DetectionSetGroupRed:FilterPrefixes( { "Red EWR" } )
DetectionSetGroupRed:FilterStart()
RedDetection = DETECTION_AREAS:New( DetectionSetGroup, 30000 )

-- Setup the A2A dispatcher, and initialize it.
A2ADispatcherRed = AI_A2A_DISPATCHER:New( RedDetection )
...
A2ADispatcherRed:SetSquadron( "Kibrit", AIRBASE.Sinai.Kibrit_Air_Base, { "SQ Red MIG-21#1" }, 8)
A2ADispatcherRed:SetSquadron( "Inshas", AIRBASE.Sinai.Inshas_Airbase, { "SQ Red MIG-21#1" }, 2 )
A2ADispatcherRed:SetSquadron( "Baluza", AIRBASE.Sinai.Baluza, { "SQ Red MIG-21#1" }, 8)
A2ADispatcherNATO:SetSquadron( "Kedem", AIRBASE.Sinai.Kedem, { "SQ NATO F-5" }, 8)
