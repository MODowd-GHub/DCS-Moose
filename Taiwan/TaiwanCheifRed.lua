...
local SquadHatay=SQUADRON:New("SQ PLAAF J-11", 3, "6th") --Ops.Squadron#SQUADRON
...
RedChief:SetStrategy(RedChief.Strategy.TOTALWAR) --Changed this from defensive to try spawn more than one MIG flight
