...
A2ADispatcherRed:SetSquadron( "Gudauta", AIRBASE.Caucasus.Gudauta, { "SQ CCCP SU-30", "SQ CCCP SU-33" }, 8 )
A2ADispatcherRed:SetSquadron( "Sochi", AIRBASE.Caucasus.Sochi_Adler, { "SQ CCCP MIG-31" }, 2)
A2ADispatcherRed:SetSquadron( "Sukhumi", AIRBASE.Caucasus.Sukhumi_Babushara, { "SQ CCCP MIG-29"  }, 6)
A2ADispatcherNATO:SetSquadron( "Kutaisi", AIRBASE.Caucasus.Kutaisi, { "SQ NATO MIG-29", "SQ NATO SU-27" }, 4)
...
A2G_Blue:SetSquadron( "BAI", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO SU-25", "SQ NATO A-10" }, 4 )
...
A2G_Blue:SetSquadron( "CAS", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO A-10" }, 6 )
...
A2G_Blue:SetSquadron( "SEAD", AIRBASE.Caucasus.Senaki_Kolkhi, { "SQ NATO SEAD 29" }, 4 )
